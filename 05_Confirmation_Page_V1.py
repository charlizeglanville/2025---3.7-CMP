...
class ConfirmationPage(BasePage):
    def __init__(self, parent, controller):
        ...
        # title row 1
        self.title_label = ttk.Label(self.main_frame, text="CONFIRMATION",
        ...
        booking_label.grid(row=self.current_row, column=0, pady=(0, 20), sticky="n")
        self.current_row += 5
        ...
        safe_trip_label.grid(row=self.current_row, column=0, pady=(0, 80), sticky="n")
        self.current_row += 10

        # Buttons Frame
        button_frame = ttk.Frame(self.main_frame, style="TFrame")
        button_frame.grid(row=self.current_row, column=0, pady=(0, 20))
        ...
        another_booking_btn.grid(row=0, column=0, padx=10)
        ...
        booking_summary_btn.grid(row=0, column=1, padx=10)
...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        # Show the confirmation page first
