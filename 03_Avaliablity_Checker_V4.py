...
class SeatSelection:
    ...
    def update_availability_label(self):
        # Reset label to normal with availability text
        self.clear_error_styles()

    def submit_selection(self):
        self.clear_error_styles()  # reset error styles first
        ...
        if recliners > seats['recliners'] or bunks > seats['bunks']:
            self.avail_label.configure(text="Invalid input: Not enough seats available. Try Again :)", style="Error.TLabel")
