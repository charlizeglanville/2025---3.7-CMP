...
class BookingPreview(BasePage):
    ...
    #Save booking before confirmation
    def confirm_booking(self):
        if self.controller.booking_data:
            self.controller.all_bookings.append(self.controller.booking_data.copy())
...
class BookingSummary(BasePage):
    def __init__(self, parent, controller):
        ...
        # Force scrollable_frame width to follow canvas width
        self.canvas.bind(
            "<Configure>",
